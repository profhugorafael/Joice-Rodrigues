...
# -----------------------------
x = r'C:\Users\joice\OneDrive\Área de Trabalho\visual studio\projeto teste/inst1.txt'
...
def processaInstancias(nomeDoArquivo: str):
  ...
  return configuracoes, janela_inicial, janela_final, processamentos, janela_disponibilidade
